...
void roofit(){
	...
	if (year == "2016preVFP") {
        ...
        files = {
            ...
            {"ZH", {"ZHToMuMu_2016postVFP.root", "ZHToTauTau_2016postVFP.root", "GluGluZH_2016postVFP.root", "ZHToMuMu_2016preVFP.root", "ZHToTauTau_2016preVFP.root", "GluGluZH_2016preVFP.root", "ZHToMuMu_2017.root", "ZHToTauTau_2017.root", "GluGluZH_2017.root", "ZHToMuMu_2018.root", "ZHToTauTau_2018.root", "GluGluZH_2018.root"}},
            {"other",   {"ttHToTauTau_2016postVFP.root", "ttHToEE_2016postVFP.root", "ttHTo2L2Nu_2016postVFP.root", "ttHToTauTau_2016preVFP.root", "ttHToEE_2016preVFP.root", "ttHTo2L2Nu_2016preVFP.root", "ttHJetToNonbb_2016preVFP.root", "TWZToLL_2016preVFP.root", "HZJ_HToWWTo2L2Nu_ZTo2L_2016preVFP.root", "ttHToTauTau_2017.root", "ttHToTauTau_2018.root", "ttHToEE_2017.root", "ttHToEE_2018.root", "ttHTo2L2Nu_2017.root", "ttHTo2L2Nu_2018.root", "ttHJetToNonbb_2016postVFP.root", "ttHJetToNonbb_2017.root", "ttHJetToNonbb_2018.root", "TWZToLL_2016postVFP.root", "TWZToLL_2017.root", "TWZToLL_2018.root", "HZJ_HToWWTo2L2Nu_ZTo2L_2016postVFP.root", "HZJ_HToWWTo2L2Nu_ZTo2L_2017.root", "HZJ_HToWWTo2L2Nu_ZTo2L_2018.root"}},
    ...
    for (auto& kv : files) {
        for (const auto& fname : kv.second) {
			TFile* file = new TFile(("hist_test_nopair_DY/" + fname).c_str(), "READ");
	...
	double other_uncert = sqrt(tot_uncert_quadr["other"]+tot_uncert_quadr["DY"]+tot_uncert_quadr["VV"]+tot_uncert_quadr["VVV"]+tot_uncert_quadr["ttW"]+tot_uncert_quadr["ttZ"]+tot_uncert_quadr["WJ"]+tot_uncert_quadr["ST"]+tot_uncert_quadr["TTbar"])/h_other_bkg->Integral();
...
RooExtendPdf other_ext("other_ext", "Other Extended PDF", other_pdf, other_norm_constrained);
	...
	model.plotOn(frame, Components("zz_ext"), LineColor(3));
