...
//=======================Histograms without any cuts=============================
			if (selection == "none"){
				...
				double mT1 = calculateMT(LepV(H_pair[0].first),LepV(H_pair[0].second));
				double mT2 = calculateMT(LepV(H_pair[1].first),LepV(H_pair[1].second));
				...
				double mT1_opp = calculateMT(LepV(SFopp_pair[0].first),LepV(SFopp_pair[0].second));
				double mT2_opp = calculateMT(LepV(SFopp_pair[1].first),LepV(SFopp_pair[1].second));
				double mT3_opp = calculateMT(LepV(SFopp_pair[2].first),LepV(SFopp_pair[2].second));
				double mT4_opp = calculateMT(LepV(SFopp_pair[3].first),LepV(SFopp_pair[3].second));
...
//===================================================================================
			if(selection == "test"){//######My selections##########	
				...
				double mTtot1 = calculateMTtot(LepV(H_pair[0].first),LepV(H_pair[0].second));
				double mTtot2 = calculateMTtot(LepV(H_pair[1].first),LepV(H_pair[1].second));
				double mT1_opp = calculateMT(LepV(opp_pair[0].first),LepV(opp_pair[0].second));
				double mT2_opp = calculateMT(LepV(opp_pair[1].first),LepV(opp_pair[1].second));
				double mT3_opp = calculateMT(LepV(opp_pair[2].first),LepV(opp_pair[2].second));
				double mT4_opp = calculateMT(LepV(opp_pair[3].first),LepV(opp_pair[3].second));
