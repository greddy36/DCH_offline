...
void StackHist_2017() {
	TFile *ifile_sig = new TFile("hist_VR/HppM500_2017.root","READ");               
	TFile *ifile_DY1 = new TFile("hist_VR/DYJetsToLLM10to50_2017.root","READ");     
	TFile *ifile_DY2 = new TFile("hist_VR/DYJetsToLLM50_2017.root","READ"); 
		    
	//TFile *ifile_VV1 = new TFile("hist_VR/WGToLNuG_2017.root","READ");
	TFile *ifile_VV2 = new TFile("hist_VR/WW_2017.root","READ");
	TFile *ifile_VV3 = new TFile("hist_VR/WWTo2L2Nu_2017.root","READ");
	//TFile *ifile_VV4 = new TFile("hist_VR/WZ_2017.root","READ");
	TFile *ifile_VV5 = new TFile("hist_VR/WZTo2Q2L_2017.root","READ");
	TFile *ifile_VV6 = new TFile("hist_VR/WZTo3LNu_2017.root","READ");

	TFile *ifile_VVV1 = new TFile("hist_VR/WWW_2017.root","READ");
	TFile *ifile_VVV2 = new TFile("hist_VR/WZZ_2017.root","READ");
	TFile *ifile_VVV3 = new TFile("hist_VR/ZZZ_2017.root","READ");

	TFile *ifile_ttV1 = new TFile("hist_VR/ttWJets_2017.root","READ");
	TFile *ifile_ttV2 = new TFile("hist_VR/ttZJets_2017.root","READ");
	
	TFile *ifile_WJ1 = new TFile("hist_VR/WJetsToLNu_NLO_2017.root","READ");
	TFile *ifile_WJ2 = new TFile("hist_VR/WJetsToLNu_HT-70To100_2017.root","READ");
	TFile *ifile_WJ3 = new TFile("hist_VR/WJetsToLNu_HT-100To200_2017.root","READ");
	TFile *ifile_WJ4 = new TFile("hist_VR/WJetsToLNu_HT-200To400_2017.root","READ");
	TFile *ifile_WJ5 = new TFile("hist_VR/WJetsToLNu_HT-400To600_2017.root","READ");
	TFile *ifile_WJ6 = new TFile("hist_VR/WJetsToLNu_HT-600To800_2017.root","READ");
	TFile *ifile_WJ7 = new TFile("hist_VR/WJetsToLNu_HT-800To1200_2017.root","READ");
	//TFile *ifile_WJ8 = new TFile("hist_VR/WJetsToLNu_HT-1200To2500_2017.root","READ");
	//TFile *ifile_WJ9 = new TFile("hist_VR/WJetsToLNu_HT-2500ToInf_2017.root","READ");
	
	TFile *ifile_ZZ1 = new TFile("hist_VR/ZZTo2L2Nu_2017.root","READ");
	TFile *ifile_ZZ2 = new TFile("hist_VR/ZZTo2Q2L_2017.root","READ");
	TFile *ifile_ZZ3 = new TFile("hist_VR/ZZTo4L_2017.root","READ");

	TFile *ifile_ST1 = new TFile("hist_VR/ST_s-channel_2017.root","READ");          
	TFile *ifile_ST2 = new TFile("hist_VR/ST_t-channel_antitop_2017.root","READ");  
	TFile *ifile_ST3 = new TFile("hist_VR/ST_t-channel_top_2017.root","READ");  
	TFile *ifile_ST4 = new TFile("hist_VR/ST_tW_antitop_2017.root","READ");  
	TFile *ifile_ST5 = new TFile("hist_VR/ST_tW_top_2017.root","READ");            

	//TFile *ifile_ttH1 = new TFile("hist_VR/ttHTo2L2Nu_2017.root","READ");
	//TFile *ifile_ttH2 = new TFile("hist_VR/ttHToEE_2017.root","READ");
	//TFile *ifile_ttH3 = new TFile("hist_VR/ttHToMuMu_2017.root","READ");
	TFile *ifile_ttH4 = new TFile("hist_VR/ttHToTauTau_2017.root","READ");
	
	TFile *ifile_TTbar1 = new TFile("hist_VR/TTTo2L2Nu_2017.root","READ");
	TFile *ifile_TTbar2 = new TFile("hist_VR/TTToSemiLeptonic_2017.root","READ");
	TFile *ifile_TTbar3 = new TFile("hist_VR/TTToHadronic_2017.root","READ");
	
	TFile *ifile_ZH1 = new TFile("hist_VR/ZHToMuMu_2017.root","READ");
	//TFile *ifile_ZH2 = new TFile("hist_VR/ZHToTauTau_2017.root","READ");
	TFile *ifile_ZH3 = new TFile("hist_VR/GluGluZH_2017.root","READ");
	
	TFile *ifile_D1 = new TFile("hist_VR/SingleElectron_2017.root","READ");
	//TFile *ifile_D2 = new TFile("hist_VR/DoubleMuon_2017.root","READ");
	//TFile *ifile_D3 = new TFile("hist_VR/Tau_2017.root","READ");
	//TFile *ifile_D4 = new TFile("hist_VR/MuonEG_2017.root","READ");
	TFile *ifile_D5 = new TFile("hist_VR/SingleMuon_2017.root","READ");

	const char *hist_list[] = {"0tau/h_mll1","1tau/h_mll1","2tau/h_mll1","3tau/h_mll1","3lep0tau","3lep1tau/h_mll1","3lep2tau/h_mll1",/*"h_Xmass_0t","h_Xmass_1t","h_Xmass_2t", "h_Xmass_3t", "h_Xmass_0t3l","h_Xmass_1t3l","h_Xmass_2t3l", *//*"h_ST", "h_ll1_pt_4L","h_ll1_pt_3L","h_mZ1", "h_mZ2","h_mZ3","h_mZ4","h_mZ1_3L", "h_mZ2_3L","h_mZ3_3L","h_mZ4_3L","h_met","h_pT1","h_pT2","h_pT3","h_pT4","h_dR","h_dRll","h_dRll2"*/};
	
	const char *hist_names[] = {"M_{ll} in 0#tau 4l region","M_{ll} in 1#tau 4l region", "M_{ll} in 2#tau 4l region", "M_{ll} in 3#tau 4l region", "M_{ll} in 0#tau 3l region","M_{ll} in 1#tau 3l region", "M_{ll} in 2#tau 3l region",/* "ST", "Leading pair pT in 4L","Leading pair pT in 3L","Z mass from pair (1,3) in 4L", "Z mass from pair (1,4) in 4L","Z mass from pair (2,3) in 4L","Z mass from pair (2,4) in 4L", "Z mass from pair (1,3) in 3L", "Z mass from pair (1,4) in 3L","Z mass from pair (2,3)","Z mass from pair (2,4)","MET","Leading pT","Sub-Leading pT","3rd pT","4th pT","dR (+-) leptons; DR; Events","dR between 1st pair", "dR between 2nd pair"*/};
...
// make changes to take in xs from a csv file
	for(int i = 0; i < sizeof(hist_list)/sizeof(hist_list[0]); i++){
		TH1D *h_sig = (TH1D*)ifile_sig->Get(hist_list[i]); h_sig->SetLineStyle(5);h_sig->SetLineWidth(2);h_sig->SetLineColor(2);h_sig->Scale(1);
		...
		float Sig_count = h_sig->Integral();
		...
		TString Sig_legend = "M500"+TString::Format("\t %.2f", Sig_count);
		...
		legend->AddEntry(h_sig, Sig_legend, "f");
...
h_ratio->SetMaximum(2); // Set the maximum y-value for the ratio plot
		...
		std::string s =  "hist_VR/2017/", s1, s2;
